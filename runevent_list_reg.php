...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>ข้อมูลผู้สมัครงานวิ่ง</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">

                        <li class="breadcrumb-item active">ข้อมูลผู้สมัครงานวิ่ง</li>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div align="center">
                                    ...
                                    <a href="runevent_list_reg_type.php?id_running_event=<?=$result_running_event['id_running_event'];?>"
