...
<a href="javascript:history.back(1)" class="btn btn-primary"> ย้อนกลับ</a>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">แก้ไขข้อมูลการสมัครวิ่ง</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
 ...
 <input type="text" name="name_user" class="form-control" id="exampleInputEmail1" placeholder="ชื่อผู้สมัครวิ่ง" required >
                  </div>
